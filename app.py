...
def spell():
    if request.method == 'POST':
        ...
        grammar_corrections, grammar_count = spell_checker_module.correct_grammar(text)
...
def grammar():
    if request.method == 'POST':
        ...
        file_grammar_corrections, file_grammar_count = spell_checker_module.correct_grammar(readable_file)
        return render_template(
            'index.html',
            corrected_file_text=corrected_file_text,
            corrected_file_grammar=file_grammar_corrections,
            corrected_file_grammar_count=file_grammar_count
        )
    return render_template('index.html')
